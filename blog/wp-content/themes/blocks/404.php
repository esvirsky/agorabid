...
<div id="container">
	...
	<div id="notice">
		<p><?php _e("Welcome to this customized error page. You've reached this page because you've clicked on a link that does not exist. This is probably our fault... but instead of showing you the basic '404 Error' page that is confusing and doesn't really explain anything, we've created this page to explain what went wrong.", 'blocks'); ?></p>
		<p><?php _e("You can either (a) click on the 'back' button in your browser and try to navigate through our site in a different direction, or (b) click on the following link to go to homepage.", 'blocks'); ?></p>
		<div class="back">
			<a href="<?php bloginfo('url'); ?>/"><?php _e('Back to homepage &raquo;', 'blocks'); ?></a>
		</div>
	</div>
</div>
