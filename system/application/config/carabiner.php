...
*/
$CI =& get_instance();
$config['dev'] = !$CI->config->item("live");
...
/* Eddie - my groups */
$config['groups']['global'] = array(

	"js" => array(
				array("third_party/jquery-latest.min.js"),
				array("third_party/jquery.validate.js"),
				array("third_party/jquery.json-1.3.min.js"),
				array("global.js")
			),
	"css" => array(
				array("style.css"),
				...
				array("auth.css"),
				array("user.css"),
				array("service_request.css")
			)
);

/* Eddie - commented out all of these groups
